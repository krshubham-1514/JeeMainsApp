...
public class ListviewAdvanceSolvedAdapter extends ArrayAdapter<String> {
    Context context;
    final int type;
    public int[] academics_listview_icons;
    public String[] academics_listview_text;
    public String[] listview_textview_paper_arr;



    public ListviewAdvanceSolvedAdapter( Context context, int[]academics_listview_icons,String[]academics_listview_text,String[] listview_textview_paper) {
        super(context, R.layout.listview_items_paper, R.id.textlistview_common,academics_listview_text);

        this.context=context;
        this.listview_textview_paper_arr=listview_textview_paper;
    ...
    public View getView(final int position,View convertView, ViewGroup parent) {
        ...
        listview_textview_paper.setText(listview_textview_paper_arr[position]);
