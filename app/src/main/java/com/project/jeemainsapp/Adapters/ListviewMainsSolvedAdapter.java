...
public class ListviewMainsSolvedAdapter extends ArrayAdapter<String> {
    Context context;
    final int type;
    ...
    public ListviewMainsSolvedAdapter( Context context, int[]academics_listview_icons,String[]academics_listview_text,String[]listview_textview_set) {
