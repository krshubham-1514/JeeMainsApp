...
public class ListviewMainsUnsolvedAdapter extends ArrayAdapter<String> {
    Context context;
    final int type;
    public int[] academics_listview_icons;
    public String[] academics_listview_text;
    public String[] listview_textview_set_arr;



    public ListviewMainsUnsolvedAdapter( Context context, int[]academics_listview_icons,String[]academics_listview_text,String[]listview_textview_set) {
        super(context, R.layout.listview_items_paper, R.id.textlistview_common,academics_listview_text);

        this.context=context;
        this.listview_textview_set_arr=listview_textview_set;
    ...
    public View getView(final int position,View convertView, ViewGroup parent) {
        ...
        TextView listview_textview_set=(TextView) row.findViewById(R.id.textlistview_common_set);
        ...
        listview_textview_set.setText(listview_textview_set_arr[position]);
